$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181031145752196 [itable="header"] input[imapvalue="B"]').val("10000012180");$('#Form20181031145752196 [itable="header"] input[imapvalue="C"]').val("000");$('#Form20181031145752196 [itable="header"] input[imapvalue="A"]').val("A11");$('#Form20181031145752196 [itable="header"] input[imapvalue="D"]').val("00");
        e.preventDefault();
    });
