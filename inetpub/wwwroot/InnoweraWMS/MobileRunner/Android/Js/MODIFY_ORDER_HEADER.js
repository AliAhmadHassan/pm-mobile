$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181122155323892 [itable="Detail0"] input[imapvalue="A"]').val("008000004821");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="N"]').val("EQ00801");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="J"]').val("MEO");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="L"]').val("MMP");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="P"]').val("010EESALEM01-EEE01-CCB01-PAI01");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="R"]').val("4004459");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="T"]').attr("data-date", moment("2018-11-22","YYYY-MM-DD").format($('#Form20181122155323892 [itable="Detail0"] input[imapvalue="T"]').attr("data-date-format")));$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="V"]').attr("data-date", moment("2018-11-22","YYYY-MM-DD").format($('#Form20181122155323892 [itable="Detail0"] input[imapvalue="V"]').attr("data-date-format")));$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="H"]').val("INNOWERA 1911");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="O"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="K"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="M"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="Q"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="S"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="U"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="W"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="I"]').val("X");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="C"]').val("000001");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="D"]').val("HEADER");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="E"]').val("CHANGE");$('#Form20181122155323892 [itable="Detail0"] input[imapvalue="F"]').val("008000004821"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
