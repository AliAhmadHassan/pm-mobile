$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190715101137799 [itable="header"] input[imapvalue="U"]').val("");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="A"]').val("60556");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="B"]').val("008000003704");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="C"]').val("0040");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="D"]').val(" ");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="P"]').val("");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="Q"]').attr("data-date", moment("2019-07-15","YYYY-MM-DD").format($('#Form20190715101137799 [itable="Detail0"] input[imapvalue="Q"]').attr("data-date-format")));$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="N"]').val("COCL");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="O"]').val("TESTE DE CONFIRMAÇÃO3");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="E"]').val("0002");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="F"]').val("EQ00164");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="L"]').val("6.0");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="M"]').val("H");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="H"]').attr("data-date", moment("2019-07-15","YYYY-MM-DD").format($('#Form20190715101137799 [itable="Detail0"] input[imapvalue="H"]').attr("data-date-format")));$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="I"]').val("10:00:00");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="J"]').attr("data-date", moment("2019-07-15","YYYY-MM-DD").format($('#Form20190715101137799 [itable="Detail0"] input[imapvalue="J"]').attr("data-date-format")));$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="K"]').val("11:00:00");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="G"]').val("00034202");$('#Form20190715101137799 [itable="Detail0"] input[imapvalue="V"]').val(""); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
    ...
    function ProcessOperationError(jsonError) {
        ...
        /*else {
            navigator.notification.confirm("There is an error while processing record. Please contact to your IT Administrator.",function(btnIndex) {
                if(jsonError.statusText.toLowerCase() != "error" && jsonError.status != 0) {
