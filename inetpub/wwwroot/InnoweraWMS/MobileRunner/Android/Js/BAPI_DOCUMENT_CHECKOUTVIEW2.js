$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190314103325779 [itable="header"] input[imapvalue="J"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="L"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="K"]').attr("data-date", moment("2019-03-14","YYYY-MM-DD").format($('#Form20190314103325779 [itable="header"] input[imapvalue="K"]').attr("data-date-format")));$('#Form20190314103325779 [itable="header"] input[imapvalue="A"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="C"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="D"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="BX"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="BY"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="BZ"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="CA"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="F"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="I"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="E"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="H"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="G"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="N"]').val("");$('#Form20190314103325779 [itable="header"] input[imapvalue="M"]').val("");
        e.preventDefault();
    });
