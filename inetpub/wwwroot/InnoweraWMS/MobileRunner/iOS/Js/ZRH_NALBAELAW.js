$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190103151408160 [itable="Detail0"] input[imapvalue="A"]').val("115182");$('#Form20190103151408160 [itable="Detail0"] input[imapvalue="C"]').val("");$('#Form20190103151408160 [itable="Detail0"] input[imapvalue="B"]').val(""); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
