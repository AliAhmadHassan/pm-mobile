$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190315194801089 [itable="header"] input[imapvalue="A"]').val("");$('#Form20190315194801089 [itable="header"] input[imapvalue="B"]').val("4019134");$('#Form20190315194801089 [itable="header"] input[imapvalue="E"]').val("");$('#Form20190315194801089 [itable="header"] input[imapvalue="F"]').val("");$('#Form20190315194801089 [itable="header"] input[imapvalue="C"]').val("");$('#Form20190315194801089 [itable="header"] input[imapvalue="D"]').val("");
        e.preventDefault();
    });
