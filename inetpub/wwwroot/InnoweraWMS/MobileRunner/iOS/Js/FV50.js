$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190715135215075 [itable="header"] input[imapvalue="A"]').attr("data-date", moment("2019-07-15","YYYY-MM-DD").format($('#Form20190715135215075 [itable="header"] input[imapvalue="A"]').attr("data-date-format")));$('#Form20190715135215075 [itable="header"] input[imapvalue="B"]').val("teste");$('#Form20190715135215075 [itable="header"] input[imapvalue="C"]').val("teste");$('#Form20190715135215075 [itable="header"] input[imapvalue="D"]').val("4106011008");$('#Form20190715135215075 [itable="header"] input[imapvalue="E"]').val("             0,00");$('#Form20190715135215075 [itable="header"] input[imapvalue="F"]').val("EC00017000");$('#Form20190715135215075 [itable="header"] input[imapvalue="H"]').val("");$('#Form20190715135215075 [itable="header"] input[imapvalue="G"]').val("0,60");
        e.preventDefault();
    });
