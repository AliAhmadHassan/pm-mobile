$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181205113939419 [itable="header"] input[imapvalue="C"]').val("");$('#Form20181205113939419 [itable="header"] input[imapvalue="B"]').val("");$('#Form20181205113939419 [itable="header"] input[imapvalue="A"]').val("100BOOACKEL1-BST01-GBT01-BOM01");
        e.preventDefault();
    });
