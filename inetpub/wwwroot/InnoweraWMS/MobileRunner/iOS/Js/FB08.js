$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190625134017707 [itable="header"] input[imapvalue="A"]').val("101608302");$('#Form20190625134017707 [itable="header"] input[imapvalue="B"]').val("SBSP");$('#Form20190625134017707 [itable="header"] input[imapvalue="C"]').val("2018");$('#Form20190625134017707 [itable="header"] input[imapvalue="D"]').val("01");$('#Form20190625134017707 [itable="header"] input[imapvalue="E"]').val("17.06.2016");
        e.preventDefault();
    });
