$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308092145854 [itable="header"] input[imapvalue="A"]').val("");$('#Form20190308092145854 [itable="header"] input[imapvalue="B"]').val("A01");$('#Form20190308092145854 [itable="header"] input[imapvalue="C"]').val("");$('#Form20190308092145854 [itable="header"] input[imapvalue="D"]').val("");$('#Form20190308092145854 [itable="header"] input[imapvalue="E"]').val("");
        e.preventDefault();
    });
