$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181129164000457 [itable="header"] input[imapvalue="S"]').val("4013803");$('#Form20181129164000457 [itable="header"] input[imapvalue="Q"]').val("206ETEBARUR1-PDO19-DLO02-CEN02");$('#Form20181129164000457 [itable="header"] input[imapvalue="O"]').val("teste ginw");$('#Form20181129164000457 [itable="header"] input[imapvalue="K"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="C"]').attr("data-date", moment("2018-11-29","YYYY-MM-DD").format($('#Form20181129164000457 [itable="header"] input[imapvalue="C"]').attr("data-date-format")));$('#Form20181129164000457 [itable="header"] input[imapvalue="G"]').val("14:00:00");$('#Form20181129164000457 [itable="header"] input[imapvalue="E"]').attr("data-date", moment("2018-11-29","YYYY-MM-DD").format($('#Form20181129164000457 [itable="header"] input[imapvalue="E"]').attr("data-date-format")));$('#Form20181129164000457 [itable="header"] input[imapvalue="I"]').val("15:00:00");$('#Form20181129164000457 [itable="header"] input[imapvalue="T"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="R"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="P"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="L"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="D"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="H"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="F"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="J"]').val("X");$('#Form20181129164000457 [itable="header"] input[imapvalue="A"]').val("10112340");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AA"]').val("0005");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AC"]').val("0005");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AI"]').val("PM-DEFEI");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AK"]').val("0050");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AE"]').val("PM-OBJET");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AG"]').val("0040");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AB"]').val("0005");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AD"]').val("X");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AJ"]').val("X");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AL"]').val("X");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AF"]').val("X");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="AH"]').val("X");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="BB"]').val("");$('#Form20181129164000457 [itable="Detail0"] input[imapvalue="BC"]').val(""); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
