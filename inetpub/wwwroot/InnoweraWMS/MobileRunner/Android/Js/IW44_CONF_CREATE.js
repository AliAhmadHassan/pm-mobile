$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190326131822161 [itable="Detail0"] input[imapvalue="A"]').val("60556");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="B"]').val("008000003704");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="C"]').val("0040");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="D"]').val(" ");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="P"]').val("");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="Q"]').attr("data-date", moment("2006-05-05","YYYY-MM-DD").format($('#Form20190326131822161 [itable="Detail0"] input[imapvalue="Q"]').attr("data-date-format")));$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="N"]').val("COCL");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="O"]').val("TESTE DE CONFIRMAÇÃO3");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="E"]').val("0002");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="F"]').val("EQ00164");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="L"]').val("6.0");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="M"]').val("H");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="H"]').attr("data-date", moment("2006-05-05","YYYY-MM-DD").format($('#Form20190326131822161 [itable="Detail0"] input[imapvalue="H"]').attr("data-date-format")));$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="I"]').val("10:00:00");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="J"]').attr("data-date", moment("2006-05-05","YYYY-MM-DD").format($('#Form20190326131822161 [itable="Detail0"] input[imapvalue="J"]').attr("data-date-format")));$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="K"]').val("11:00:00");$('#Form20190326131822161 [itable="Detail0"] input[imapvalue="G"]').val("00034202"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
