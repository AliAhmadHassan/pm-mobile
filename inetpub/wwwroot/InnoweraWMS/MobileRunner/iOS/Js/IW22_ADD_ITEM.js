$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308091814598 [itable="header"] input[imapvalue="A"]').val("10112340");$('#Form20190308091814598 [itable="Detail0"] input[imapvalue="C"]').val("0008");$('#Form20190308091814598 [itable="Detail0"] input[imapvalue="H"]').val("TESTE INW");$('#Form20190308091814598 [itable="Detail0"] input[imapvalue="F"]').val("PM-DEFEI");$('#Form20190308091814598 [itable="Detail0"] input[imapvalue="G"]').val("0035");$('#Form20190308091814598 [itable="Detail0"] input[imapvalue="D"]').val("PM-OBJET");$('#Form20190308091814598 [itable="Detail0"] input[imapvalue="E"]').val("0110"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
