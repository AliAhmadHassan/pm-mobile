$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181227083733546 [itable="Detail0"] input[imapvalue="A"]').val("IE000000000004086139");$('#Form20181227083733546 [itable="Detail0"] input[imapvalue="D"]').val("");$('#Form20181227083733546 [itable="Detail0"] input[imapvalue="B"]').attr("data-date", moment("2018-12-27","YYYY-MM-DD").format($('#Form20181227083733546 [itable="Detail0"] input[imapvalue="B"]').attr("data-date-format")));$('#Form20181227083733546 [itable="Detail0"] input[imapvalue="C"]').attr("data-date", moment("2018-12-27","YYYY-MM-DD").format($('#Form20181227083733546 [itable="Detail0"] input[imapvalue="C"]').attr("data-date-format"))); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
