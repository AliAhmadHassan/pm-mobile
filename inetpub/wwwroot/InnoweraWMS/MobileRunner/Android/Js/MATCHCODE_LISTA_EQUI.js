$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190222101200788 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190222101200788 [itable="header"] input[imapvalue="C"]').val("*BOMBA*");$('#Form20190222101200788 [itable="header"] input[imapvalue="A"]').val("");$('#Form20190222101200788 [itable="header"] input[imapvalue="D"]').val("");$('#Form20190222101200788 [itable="header"] input[imapvalue="E"]').val("0003");
        e.preventDefault();
    });
