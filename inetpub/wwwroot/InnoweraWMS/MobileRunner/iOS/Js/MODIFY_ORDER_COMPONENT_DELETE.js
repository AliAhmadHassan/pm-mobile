$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181127095552299 [itable="Detail0"] input[imapvalue="H"]').val("0000197526");$('#Form20181127095552299 [itable="Detail0"] input[imapvalue="I"]').val("0002");$('#Form20181127095552299 [itable="Detail0"] input[imapvalue="J"]').val("0020");$('#Form20181127095552299 [itable="Detail0"] input[imapvalue="C"]').val("000001");$('#Form20181127095552299 [itable="Detail0"] input[imapvalue="D"]').val("COMPONENT");$('#Form20181127095552299 [itable="Detail0"] input[imapvalue="E"]').val("DELETE");$('#Form20181127095552299 [itable="Detail0"] input[imapvalue="F"]').val("00800010344200001975260002"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
