$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190122153321710 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190122153321710 [itable="header"] input[imapvalue="C"]').val("*BOMBA*");$('#Form20190122153321710 [itable="header"] input[imapvalue="A"]').val("");$('#Form20190122153321710 [itable="header"] input[imapvalue="D"]').val("");$('#Form20190122153321710 [itable="header"] input[imapvalue="E"]').val("0003");
        e.preventDefault();
    });
