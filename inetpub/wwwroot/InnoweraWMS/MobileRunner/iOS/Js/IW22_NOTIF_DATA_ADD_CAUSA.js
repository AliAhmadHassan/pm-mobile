$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190515105803879 [itable="header"] input[imapvalue="A"]').val("10142591");$('#Form20190515105803879 [itable="Detail0"] input[imapvalue="F"]').val("0001");$('#Form20190515105803879 [itable="Detail0"] input[imapvalue="D"]').val("0001");$('#Form20190515105803879 [itable="Detail0"] input[imapvalue="E"]').val("TESTE PROCESS RUNNER CAUSA");$('#Form20190515105803879 [itable="Detail0"] input[imapvalue="G"]').val("PM-CAUSA");$('#Form20190515105803879 [itable="Detail0"] input[imapvalue="H"]').val("0010");$('#Form20190515105803879 [itable="Detail0"] input[imapvalue="C"]').val("0001"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
