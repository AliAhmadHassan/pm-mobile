$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308092218730 [itable="header"] input[imapvalue="A"]').val("10000019929");$('#Form20190308092218730 [itable="header"] input[imapvalue="C"]').val("000");$('#Form20190308092218730 [itable="header"] input[imapvalue="B"]').val("A11");$('#Form20190308092218730 [itable="header"] input[imapvalue="D"]').val("00");$('#Form20190308092218730 [itable="Detail0"] input[imapvalue="E"]').val("000010111766"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
