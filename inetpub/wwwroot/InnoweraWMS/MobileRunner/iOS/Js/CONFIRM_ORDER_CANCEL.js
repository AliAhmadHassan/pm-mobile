$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181220113157855 [itable="header"] input[imapvalue="A"]').val("968289");$('#Form20181220113157855 [itable="header"] input[imapvalue="B"]').val("2");$('#Form20181220113157855 [itable="header"] input[imapvalue="C"]').val("TESTE BAPI 20.12.2018");
        e.preventDefault();
    });
