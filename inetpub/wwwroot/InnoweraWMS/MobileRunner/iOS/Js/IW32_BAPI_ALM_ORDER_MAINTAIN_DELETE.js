$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190423152649336 [itable="Detail0"] input[imapvalue="C"]').val("000001");$('#Form20190423152649336 [itable="Detail0"] input[imapvalue="D"]').val("OPERATION");$('#Form20190423152649336 [itable="Detail0"] input[imapvalue="E"]').val("DELETE");$('#Form20190423152649336 [itable="Detail0"] input[imapvalue="F"]').val("0080001323420050"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
