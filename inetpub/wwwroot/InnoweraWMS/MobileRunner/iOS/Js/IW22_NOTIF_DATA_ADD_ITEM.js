$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190507130437017 [itable="header"] input[imapvalue="A"]').val("10142601");$('#Form20190507130437017 [itable="Detail0"] input[imapvalue="C"]').val("0002");$('#Form20190507130437017 [itable="Detail0"] input[imapvalue="H"]').val("Teste Guns 2");$('#Form20190507130437017 [itable="Detail0"] input[imapvalue="F"]').val("PM-DEFEI");$('#Form20190507130437017 [itable="Detail0"] input[imapvalue="G"]').val("0137");$('#Form20190507130437017 [itable="Detail0"] input[imapvalue="D"]').val("PM-OBJET");$('#Form20190507130437017 [itable="Detail0"] input[imapvalue="E"]').val("0110"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
