$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190312165949610 [itable="header"] input[imapvalue="A"]').val("5341*");$('#Form20190312165949610 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190312165949610 [itable="header"] input[imapvalue="C"]').val("");$('#Form20190312165949610 [itable="header"] input[imapvalue="D"]').val("");
        e.preventDefault();
    });
