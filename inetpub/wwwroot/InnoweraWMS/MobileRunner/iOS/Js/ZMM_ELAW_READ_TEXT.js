$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190802154854879 [itable="header"] input[imapvalue="A"]').val("k01");$('#Form20190802154854879 [itable="header"] input[imapvalue="B"]').val("p");$('#Form20190802154854879 [itable="header"] input[imapvalue="C"]').val("4600001411");$('#Form20190802154854879 [itable="header"] input[imapvalue="D"]').val("EKKO");
        e.preventDefault();
    });
