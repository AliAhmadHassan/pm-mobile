$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190409104504827 [itable="header"] input[imapvalue="E"]').val("");$('#Form20190409104504827 [itable="header"] input[imapvalue="D"]').val("a01");$('#Form20190409104504827 [itable="header"] input[imapvalue="C"]').val("");$('#Form20190409104504827 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190409104504827 [itable="header"] input[imapvalue="A"]').val("");
        e.preventDefault();
    });
