$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190516170730162 [itable="header"] input[imapvalue="A"]').val("10142591");$('#Form20190516170730162 [itable="Detail0"] input[imapvalue="B"]').val("0012");$('#Form20190516170730162 [itable="Detail0"] input[imapvalue="C"]').val("0001"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
