$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190516170808676 [itable="header"] input[imapvalue="A"]').val("10142591");$('#Form20190516170808676 [itable="Detail0"] input[imapvalue="D"]').val("3");$('#Form20190516170808676 [itable="Detail0"] input[imapvalue="C"]').val("24"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
