$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308085513560 [itable="header"] input[imapvalue="A"]').val("10112340");$('#Form20190308085513560 [itable="Detail0"] input[imapvalue="D"]').val("0004");$('#Form20190308085513560 [itable="Detail0"] input[imapvalue="C"]').val("0001"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
