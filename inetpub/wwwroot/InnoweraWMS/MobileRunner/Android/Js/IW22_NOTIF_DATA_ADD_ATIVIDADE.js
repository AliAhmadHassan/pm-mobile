$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190515110004392 [itable="header"] input[imapvalue="A"]').val("10142591");$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="C"]').val("0001");$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="D"]').val("TESTE PROCESS RUNNER ATIVIDADE ");$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="E"]').val("PM-ACAO");$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="F"]').val("0200");$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="G"]').attr("data-date", moment("2019-05-15","YYYY-MM-DD").format($('#Form20190515110004392 [itable="Detail0"] input[imapvalue="G"]').attr("data-date-format")));$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="H"]').val("8:00:00");$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="I"]').attr("data-date", moment("2019-05-15","YYYY-MM-DD").format($('#Form20190515110004392 [itable="Detail0"] input[imapvalue="I"]').attr("data-date-format")));$('#Form20190515110004392 [itable="Detail0"] input[imapvalue="J"]').val("9:00:00"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
