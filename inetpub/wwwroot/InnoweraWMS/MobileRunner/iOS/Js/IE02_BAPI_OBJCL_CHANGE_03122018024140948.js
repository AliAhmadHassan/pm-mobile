$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190318111338974 [itable="header"] input[imapvalue="C"]').val("MOT");$('#Form20190318111338974 [itable="header"] input[imapvalue="D"]').val("2");$('#Form20190318111338974 [itable="header"] input[imapvalue="E"]').attr("data-date", moment("2019-03-18","YYYY-MM-DD").format($('#Form20190318111338974 [itable="header"] input[imapvalue="E"]').attr("data-date-format")));$('#Form20190318111338974 [itable="header"] input[imapvalue="A"]').val("000000000004020761");$('#Form20190318111338974 [itable="header"] input[imapvalue="B"]').val("EQUI");$('#Form20190318111338974 [itable="Detail0"] input[imapvalue="F"]').val("PM_MAN_ALT_EIXO");$('#Form20190318111338974 [itable="Detail0"] input[imapvalue="G"]').val("3,00 m"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
