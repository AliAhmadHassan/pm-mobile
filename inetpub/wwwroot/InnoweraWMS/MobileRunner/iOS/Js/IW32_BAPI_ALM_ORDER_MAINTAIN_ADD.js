$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190423152620985 [itable="Detail0"] input[imapvalue="D"]').val("000001");$('#Form20190423152620985 [itable="Detail0"] input[imapvalue="E"]').val("OPERATION");$('#Form20190423152620985 [itable="Detail0"] input[imapvalue="F"]').val("CREATE");$('#Form20190423152620985 [itable="Detail0"] input[imapvalue="G"]').val("00800013234200500010"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="I"]').val("0050");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="J"]').val("10");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="O"]').val("PM01");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="K"]').val("EQ01012");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="P"]').val("0019");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="L"]').val("Teste Gus Innowera");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="N"]').val("");$('#Form20190423152620985 [itable="Detail1"] input[imapvalue="M"]').val(""); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail1_DetailData1", AddToList, "ADD");
        e.preventDefault();
    });
