$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190117111940498 [itable="header"] input[imapvalue="E"]').val("36571");$('#Form20190117111940498 [itable="header"] input[imapvalue="C"]').val("500553");$('#Form20190117111940498 [itable="header"] input[imapvalue="A"]').attr("data-date", moment("2019-01-17","YYYY-MM-DD").format($('#Form20190117111940498 [itable="header"] input[imapvalue="A"]').attr("data-date-format")));$('#Form20190117111940498 [itable="header"] input[imapvalue="B"]').val("11:05");$('#Form20190117111940498 [itable="header"] input[imapvalue="D"]').val("500");$('#Form20190117111940498 [itable="header"] input[imapvalue="F"]').val("Chamada para SAP bem sucedida");
        e.preventDefault();
    });
