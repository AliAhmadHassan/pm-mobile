$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190403110918574 [itable="header"] input[imapvalue="A"]').val("10142591");$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="C"]').val("1");$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="D"]').val("Teste na Innowera do Guns ");$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="E"]').val("PM-ACAO");$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="F"]').val("0200");$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="G"]').attr("data-date", moment("2019-04-03","YYYY-MM-DD").format($('#Form20190403110918574 [itable="Detail0"] input[imapvalue="G"]').attr("data-date-format")));$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="H"]').val("08:00:00");$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="I"]').attr("data-date", moment("2019-04-03","YYYY-MM-DD").format($('#Form20190403110918574 [itable="Detail0"] input[imapvalue="I"]').attr("data-date-format")));$('#Form20190403110918574 [itable="Detail0"] input[imapvalue="J"]').val("09:00:00"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
