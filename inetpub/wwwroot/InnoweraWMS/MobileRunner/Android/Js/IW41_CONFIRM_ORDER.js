$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181211153344078 [itable="header"] input[imapvalue="A"]').val("8000100286");$('#Form20181211153344078 [itable="header"] input[imapvalue="B"]').val("0050");$('#Form20181211153344078 [itable="header"] input[imapvalue="C"]').val("");$('#Form20181211153344078 [itable="header"] input[imapvalue="E"]').val("55651");$('#Form20181211153344078 [itable="header"] input[imapvalue="F"]').val("5555");$('#Form20181211153344078 [itable="header"] input[imapvalue="G"]').val("HRS");$('#Form20181211153344078 [itable="header"] input[imapvalue="N"]').val("X");$('#Form20181211153344078 [itable="header"] input[imapvalue="H"]').attr("data-date", moment("2018-12-11","YYYY-MM-DD").format($('#Form20181211153344078 [itable="header"] input[imapvalue="H"]').attr("data-date-format")));$('#Form20181211153344078 [itable="header"] input[imapvalue="I"]').val("21:00:00");$('#Form20181211153344078 [itable="header"] input[imapvalue="J"]').attr("data-date", moment("2018-12-11","YYYY-MM-DD").format($('#Form20181211153344078 [itable="header"] input[imapvalue="J"]').attr("data-date-format")));$('#Form20181211153344078 [itable="header"] input[imapvalue="K"]').val("18:00:00");$('#Form20181211153344078 [itable="header"] input[imapvalue="L"]').val("ADCG");$('#Form20181211153344078 [itable="header"] input[imapvalue="M"]').val("TESTE221020181017");
        e.preventDefault();
    });
