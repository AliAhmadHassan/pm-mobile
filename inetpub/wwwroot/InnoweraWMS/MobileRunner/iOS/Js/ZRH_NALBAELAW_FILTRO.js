$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190625113617563 [itable="Detail0"] input[imapvalue="C"]').val("");$('#Form20190625113617563 [itable="Detail0"] input[imapvalue="B"]').val("");$('#Form20190625113617563 [itable="Detail0"] input[imapvalue="A"]').val("30160"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
