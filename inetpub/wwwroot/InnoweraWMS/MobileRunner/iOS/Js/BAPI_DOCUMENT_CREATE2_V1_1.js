$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190416105512586 [itable="header"] input[imapvalue="A"]').val("DCU");$('#Form20190416105512586 [itable="header"] input[imapvalue="B"]').val("00");$('#Form20190416105512586 [itable="header"] input[imapvalue="C"]').val("000");$('#Form20190416105512586 [itable="header"] input[imapvalue="D"]').val("Testing - BAPI");$('#Form20190416105512586 [itable="header"] input[imapvalue="E"]').val("");$('#Form20190416105512586 [itable="header"] input[imapvalue="F"]').val("001");$('#Form20190416105512586 [itable="Detail0"] input[imapvalue="J"]').val("DMS_C1_ST");$('#Form20190416105512586 [itable="Detail0"] input[imapvalue="I"]').val("Txt");$('#Form20190416105512586 [itable="Detail0"] input[imapvalue="K"]').val("D:\\List_Game_V1.txt");$('#Form20190416105512586 [itable="Detail0"] input[imapvalue="L"]').val("Game List"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");$('#Form20190416105512586 [itable="Detail1"] input[imapvalue="N"]').val("EQUI");$('#Form20190416105512586 [itable="Detail1"] input[imapvalue="O"]').val("10002860"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail1_DetailData1", AddToList, "ADD");
        e.preventDefault();
    });
