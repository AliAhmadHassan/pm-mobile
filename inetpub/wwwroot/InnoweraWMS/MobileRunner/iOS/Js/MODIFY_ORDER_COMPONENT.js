$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AP"]').val("0000006852");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AQ"]').val("0003");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AR"]').val("0019");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AT"]').val("D016");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AX"]').val("0011");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AV"]').val("2");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AS"]').val("X");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AU"]').val("X");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="AW"]').val("X");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="C"]').val("000001");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="D"]').val("COMPONENT");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="E"]').val("CHANGE");$('#Form20181126143745960 [itable="Detail0"] input[imapvalue="F"]').val("00800000482100000068520003"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
