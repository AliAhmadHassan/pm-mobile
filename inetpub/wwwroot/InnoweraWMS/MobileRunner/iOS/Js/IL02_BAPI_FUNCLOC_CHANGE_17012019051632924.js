$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190117175506302 [itable="header"] input[imapvalue="D"]').val("");$('#Form20190117175506302 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190117175506302 [itable="header"] input[imapvalue="F"]').val("");$('#Form20190117175506302 [itable="header"] input[imapvalue="A"]').val("100EABCAPIV1-EEA36-GBB01-MOT01");
        e.preventDefault();
    });
