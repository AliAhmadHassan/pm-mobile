$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308091723357 [itable="header"] input[imapvalue="A"]').val("10112340");$('#Form20190308091723357 [itable="Detail0"] input[imapvalue="K"]').val("0002");$('#Form20190308091723357 [itable="Detail0"] input[imapvalue="L"]').val("0002");$('#Form20190308091723357 [itable="Detail0"] input[imapvalue="M"]').val("Teste inw");$('#Form20190308091723357 [itable="Detail0"] input[imapvalue="N"]').val("PM-CAUSA");$('#Form20190308091723357 [itable="Detail0"] input[imapvalue="O"]').val("0190");$('#Form20190308091723357 [itable="Detail0"] input[imapvalue="P"]').val("0002"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
