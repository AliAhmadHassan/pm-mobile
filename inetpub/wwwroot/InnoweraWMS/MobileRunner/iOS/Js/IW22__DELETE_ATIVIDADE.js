$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308085436353 [itable="header"] input[imapvalue="A"]').val("10112340");$('#Form20190308085436353 [itable="Detail0"] input[imapvalue="B"]').val("0005"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
