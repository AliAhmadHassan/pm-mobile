$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181227094709626 [itable="header"] input[imapvalue="C"]').val("");$('#Form20181227094709626 [itable="header"] input[imapvalue="B"]').val("");$('#Form20181227094709626 [itable="header"] input[imapvalue="A"]').val("010ADUGUART1-POV01");
        e.preventDefault();
    });
