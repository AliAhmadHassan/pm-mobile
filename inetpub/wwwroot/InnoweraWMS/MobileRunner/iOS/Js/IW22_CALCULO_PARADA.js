$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308091947318 [itable="header"] input[imapvalue="B"]').attr("data-date", moment("2019-03-08","YYYY-MM-DD").format($('#Form20190308091947318 [itable="header"] input[imapvalue="B"]').attr("data-date-format")));$('#Form20190308091947318 [itable="header"] input[imapvalue="A"]').attr("data-date", moment("2019-03-08","YYYY-MM-DD").format($('#Form20190308091947318 [itable="header"] input[imapvalue="A"]').attr("data-date-format")));$('#Form20190308091947318 [itable="header"] input[imapvalue="D"]').val("15:00:00");$('#Form20190308091947318 [itable="header"] input[imapvalue="C"]').val("14:00:00");
        e.preventDefault();
    });
