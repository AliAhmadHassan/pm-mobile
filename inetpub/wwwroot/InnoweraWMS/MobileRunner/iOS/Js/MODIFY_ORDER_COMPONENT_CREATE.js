$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181126150849853 [itable="Detail0"] input[imapvalue="BD"]').val("0000006852");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="BC"]').val("0002");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AV"]').val("30006818");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AY"]').val("0019");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="BE"]').val("D016");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AT"]').val("0020");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AQ"]').val("0020");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="BA"]').val("24");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AX"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AW"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AZ"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="BF"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AS"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AU"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="AR"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="BB"]').val("X");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="C"]').val("000001");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="D"]').val("COMPONENT");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="E"]').val("CREATE");$('#Form20181126150849853 [itable="Detail0"] input[imapvalue="F"]').val("008000103442"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
