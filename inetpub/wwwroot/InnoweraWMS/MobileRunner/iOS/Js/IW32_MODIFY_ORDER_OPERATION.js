$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181205110521276 [itable="Detail0"] input[imapvalue="C"]').val("000001");$('#Form20181205110521276 [itable="Detail0"] input[imapvalue="D"]').val("OPERATION");$('#Form20181205110521276 [itable="Detail0"] input[imapvalue="E"]').val("CHANGE");$('#Form20181205110521276 [itable="Detail0"] input[imapvalue="F"]').val("0080000048210011"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="Z"]').val("0011");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="AB"]').val("");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="AD"]').val("EQ00802");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="AL"]').val("0019");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="AF"]').val("INW 26.11.2018");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="AJ"]').val("");$('#Form20181205110521276 [itable="Detail1"] input[imapvalue="AH"]').val(""); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail1_DetailData1", AddToList, "ADD");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AA"]').val("X");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AC"]').val("");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AN"]').val("X");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AE"]').val("X");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AM"]').val("X");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AG"]').val("X");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AK"]').val("X");$('#Form20181205110521276 [itable="Detail2"] input[imapvalue="AI"]').val("X"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail2_DetailData2", AddToList, "ADD");
        e.preventDefault();
    });
