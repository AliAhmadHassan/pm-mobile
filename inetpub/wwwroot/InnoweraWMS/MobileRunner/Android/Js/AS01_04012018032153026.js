$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20180105101618010 [itable="header"] input[imapvalue="A"]').val("EL140124");$('#Form20180105101618010 [itable="header"] input[imapvalue="B"]').val("sbsp");$('#Form20180105101618010 [itable="header"] input[imapvalue="C"]').val("1");$('#Form20180105101618010 [itable="header"] input[imapvalue="D"]').val("LIGAÇÃO DE ESGOTO");$('#Form20180105101618010 [itable="header"] input[imapvalue="E"]').val("L201712001110000363043047");$('#Form20180105101618010 [itable="header"] input[imapvalue="F"]').val("1");$('#Form20180105101618010 [itable="header"] input[imapvalue="G"]').val("un");$('#Form20180105101618010 [itable="header"] input[imapvalue="H"]').val("6304304712");$('#Form20180105101618010 [itable="header"] input[imapvalue="I"]').val("0006");$('#Form20180105101618010 [itable="header"] input[imapvalue="J"]').val("0001");$('#Form20180105101618010 [itable="header"] input[imapvalue="K"]').val("0000");$('#Form20180105101618010 [itable="header"] input[imapvalue="L"]').val("0006");$('#Form20180105101618010 [itable="header"] input[imapvalue="M"]').val("1100001");$('#Form20180105101618010 [itable="header"] input[imapvalue="N"]').val("000002");$('#Form20180105101618010 [itable="header"] input[imapvalue="O"]').val("000025");
        e.preventDefault();
    });
