$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190318111425660 [itable="header"] input[imapvalue="C"]').val("RTF");$('#Form20190318111425660 [itable="header"] input[imapvalue="D"]').val("3");$('#Form20190318111425660 [itable="header"] input[imapvalue="E"]').attr("data-date", moment("2019-03-18","YYYY-MM-DD").format($('#Form20190318111425660 [itable="header"] input[imapvalue="E"]').attr("data-date-format")));$('#Form20190318111425660 [itable="header"] input[imapvalue="A"]').val("100CRACBELO1-CAT01-PCA01-RTF01");$('#Form20190318111425660 [itable="header"] input[imapvalue="B"]').val("IFLOT");$('#Form20190318111425660 [itable="Detail0"] input[imapvalue="F"]').val("PM_MAN_APLICACAO");$('#Form20190318111425660 [itable="Detail0"] input[imapvalue="G"]').val("PROTEÇÃO CATÓDICA"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
