$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190715134843731 [itable="header"] input[imapvalue="A"]').val("7000007073");$('#Form20190715134843731 [itable="header"] input[imapvalue="B"]').attr("data-date", moment("2019-07-15","YYYY-MM-DD").format($('#Form20190715134843731 [itable="header"] input[imapvalue="B"]').attr("data-date-format")));$('#Form20190715134843731 [itable="header"] input[imapvalue="C"]').val("CJ: 3/18");$('#Form20190715134843731 [itable="header"] input[imapvalue="D"]').attr("data-date", moment("2019-07-15","YYYY-MM-DD").format($('#Form20190715134843731 [itable="header"] input[imapvalue="D"]').attr("data-date-format")));$('#Form20190715134843731 [itable="header"] input[imapvalue="E"]').val("0,60");$('#Form20190715134843731 [itable="header"] input[imapvalue="F"]').val("0001");$('#Form20190715134843731 [itable="header"] input[imapvalue="G"]').val("TESTE");$('#Form20190715134843731 [itable="header"] input[imapvalue="H"]').val("4102011666");$('#Form20190715134843731 [itable="header"] input[imapvalue="I"]').val("             0,60");$('#Form20190715134843731 [itable="header"] input[imapvalue="J"]').val("6A22000010");$('#Form20190715134843731 [itable="header"] input[imapvalue="K"]').val("");$('#Form20190715134843731 [itable="header"] input[imapvalue="L"]').val("SB01");$('#Form20190715134843731 [itable="header"] input[imapvalue="M"]').val("3");$('#Form20190715134843731 [itable="header"] input[imapvalue="N"]').val("I");$('#Form20190715134843731 [itable="header"] input[imapvalue="O"]').val("A");$('#Form20190715134843731 [itable="header"] input[imapvalue="P"]').val("BB009");$('#Form20190715134843731 [itable="header"] input[imapvalue="Q"]').val("MV006");$('#Form20190715134843731 [itable="header"] input[imapvalue="R"]').val("00030");$('#Form20190715134843731 [itable="header"] input[imapvalue="S"]').val("500552");
        e.preventDefault();
    });
