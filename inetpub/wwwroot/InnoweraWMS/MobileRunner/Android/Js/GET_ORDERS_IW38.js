$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190205110033374 [itable="header"] input[imapvalue="A"]').val("");$('#Form20190205110033374 [itable="header"] input[imapvalue="B"]').val("");$('#Form20190205110033374 [itable="header"] input[imapvalue="E"]').val("");$('#Form20190205110033374 [itable="header"] input[imapvalue="F"]').val("");$('#Form20190205110033374 [itable="header"] input[imapvalue="C"]').val("");$('#Form20190205110033374 [itable="header"] input[imapvalue="D"]').val("EQ00802");
        e.preventDefault();
    });
