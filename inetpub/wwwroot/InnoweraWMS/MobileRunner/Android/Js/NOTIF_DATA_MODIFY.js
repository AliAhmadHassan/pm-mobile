$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181127135227334 [itable="header"] input[imapvalue="K"]').val("X");$('#Form20181127135227334 [itable="header"] input[imapvalue="C"]').attr("data-date", moment("2018-11-27","YYYY-MM-DD").format($('#Form20181127135227334 [itable="header"] input[imapvalue="C"]').attr("data-date-format")));$('#Form20181127135227334 [itable="header"] input[imapvalue="G"]').val("14:00:00");$('#Form20181127135227334 [itable="header"] input[imapvalue="E"]').attr("data-date", moment("2018-11-27","YYYY-MM-DD").format($('#Form20181127135227334 [itable="header"] input[imapvalue="E"]').attr("data-date-format")));$('#Form20181127135227334 [itable="header"] input[imapvalue="I"]').val("15:00:00");$('#Form20181127135227334 [itable="header"] input[imapvalue="L"]').val("X");$('#Form20181127135227334 [itable="header"] input[imapvalue="D"]').val("X");$('#Form20181127135227334 [itable="header"] input[imapvalue="H"]').val("X");$('#Form20181127135227334 [itable="header"] input[imapvalue="F"]').val("X");$('#Form20181127135227334 [itable="header"] input[imapvalue="J"]').val("X");$('#Form20181127135227334 [itable="header"] input[imapvalue="A"]').val("10005304");
        e.preventDefault();
    });
