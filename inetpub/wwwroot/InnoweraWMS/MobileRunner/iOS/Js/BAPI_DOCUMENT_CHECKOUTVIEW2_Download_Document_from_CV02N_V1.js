$(document).ready(function() {
    ...
    $(document).on("touchend", "[itag='inserttestdata']", function(e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190322145328258 [itable="header"] input[imapvalue="A"]').val("0000000000000010000000340");
...
// Download File From IWMS Server and File store in device //
function downloadFileFromServer(e) {
    ...
    var fileURL = cordova.file.documentsDirectory + _currentPath.split("/")[5];
