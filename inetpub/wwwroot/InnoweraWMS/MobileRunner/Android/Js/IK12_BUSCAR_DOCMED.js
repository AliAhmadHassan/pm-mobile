$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181228160654935 [itable="header"] input[imapvalue="B"]').val("");$('#Form20181228160654935 [itable="header"] input[imapvalue="E"]').attr("data-date", moment("2018-12-28","YYYY-MM-DD").format($('#Form20181228160654935 [itable="header"] input[imapvalue="E"]').attr("data-date-format")));$('#Form20181228160654935 [itable="header"] input[imapvalue="D"]').attr("data-date", moment("2018-12-28","YYYY-MM-DD").format($('#Form20181228160654935 [itable="header"] input[imapvalue="D"]').attr("data-date-format")));$('#Form20181228160654935 [itable="header"] input[imapvalue="G"]').val("");$('#Form20181228160654935 [itable="header"] input[imapvalue="F"]').val("");$('#Form20181228160654935 [itable="header"] input[imapvalue="A"]').val("36478");$('#Form20181228160654935 [itable="header"] input[imapvalue="C"]').val("");
        e.preventDefault();
    });
