$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190308085557755 [itable="header"] input[imapvalue="A"]').val("10112340");$('#Form20190308085557755 [itable="Detail0"] input[imapvalue="B"]').val("0007");$('#Form20190308085557755 [itable="Detail0"] input[imapvalue="C"]').val("0006"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
