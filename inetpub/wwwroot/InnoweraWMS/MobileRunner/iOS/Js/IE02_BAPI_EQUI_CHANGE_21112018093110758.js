$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20181227084000373 [itable="header"] input[imapvalue="F"]').val("31037");$('#Form20181227084000373 [itable="header"] input[imapvalue="L"]').val("GENERAL ELETRIC");$('#Form20181227084000373 [itable="header"] input[imapvalue="P"]').val("SERIE NOVO 2");$('#Form20181227084000373 [itable="header"] input[imapvalue="N"]').val("291018.112");$('#Form20181227084000373 [itable="header"] input[imapvalue="D"]').val("EQUIPAMENTO TESTE 2");$('#Form20181227084000373 [itable="header"] input[imapvalue="R"]').val("5132001100");$('#Form20181227084000373 [itable="header"] input[imapvalue="H"]').val("883196");$('#Form20181227084000373 [itable="header"] input[imapvalue="J"]').val("031037 IDENT");$('#Form20181227084000373 [itable="header"] input[imapvalue="A"]').val("4035951");$('#Form20181227084000373 [itable="header"] input[imapvalue="B"]').attr("data-date", moment("2018-12-27","YYYY-MM-DD").format($('#Form20181227084000373 [itable="header"] input[imapvalue="B"]').attr("data-date-format")));$('#Form20181227084000373 [itable="header"] input[imapvalue="C"]').val("15:10");
        e.preventDefault();
    });
