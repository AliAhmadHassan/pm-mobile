$(document).ready(function () {
    ...
    $(document).on("touchend", "[itag='inserttestdata']",function (e) {
        ...
        $(".cancelbtn").hide();
        $('#Form20190118145451742 [itable="header"] input[imapvalue="A"]').val("10001708");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="B"]').val("1000170800000001");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="D"]').val("0001");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="C"]').val("0001");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="F"]').val("PM01");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="H"]').val("1001");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="E"]').val("PM01");$('#Form20190118145451742 [itable="Detail0"] input[imapvalue="G"]').val("1001"); var AddToList = $("button[itag='AddToList']");BLProcessFile.AddUpdateItemToList("Detail0_DetailData0", AddToList, "ADD");
        e.preventDefault();
    });
